...
const tourSchema = new mongoose.Schema(
  {
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficult is either :- easy, madium, difficult',
      },
    },
    ratingsAverage: {
      type: Number,
...
// it create vitual table but does not save in database but display to clent side as a database side.
tourSchema.virtual('durationWeeks').get(function () {
  return this.duration / 7;
});

// It is a pre hook middleware it excute before siving the document.
...
// // It is a post hook middleware it excute after siving the document.
